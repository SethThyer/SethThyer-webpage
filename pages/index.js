    ...
    <div>
      ...
      <center>
        <h3 className="inline-c">
          <a href="https://github.com/SethThyer">
            <Image src="/images/git-icon.svg" width="25rem" height="25rem" />
            &nbsp;Github
          </a>
        </h3>
        <h3 className="inline-c">
          <a href="https://twitter.com/Seth06098372">
            <Image
        ...
        <h3 className="inline-c">
          <a href="https://open.spotify.com/user/qwr2j3sfc6quajm51dtz54sde?si=c91e27cd71b4497a&nd=1">
            <Image
